...
import SampleHeader from '@/pages/explorer/sample/components/SampleHeader.vue'
import SampleImages from '@/pages/explorer/sample/components/SampleImages.vue'
import MaterialComponentsAndAttributes from '@/pages/explorer/sample/components/MaterialComponentsAndAttributes.vue'
import CuratedProcessingStepsParameters from '@/pages/explorer/sample/components/CuratedProcessingStepsParameters.vue'
import OtherSamples from '@/pages/explorer/sample/components/OtherSamples.vue'
import CuratedPropertiesOfNanocompositeSample from '@/pages/explorer/sample/components/CuratedPropertiesOfNanocompositeSample.vue'
