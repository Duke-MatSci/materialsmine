...
export default {
  ...
  data: function () {
    return {
      tool: {
        name: 'IntelligentCharacterize',
        link: 'IntelligentCharacterize',
        imageFile: 'nanomine/Intelligent_Characterization.png',
        title: 'Correlation Functions',
        text: 'The intelligent characterization tool selects the most suitable characterization method between the “physical descriptors” ' +
