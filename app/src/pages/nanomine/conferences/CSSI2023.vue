<template>
  <div class="section_teams tools-simulation">
    <div class="wrapper">
      <div>
        <h1 class="visualize_header-h1 u--margin-toplg">
      ...
      <a class="u--color-primary" target="_blank" href="https://www.cssi-pi2023.org/">
        <div class="teams_text teams_header">
          2023 NSF Cyberinfrastructure for Sustained Scientific Innovation Principal Investigator
          Meeting
        </div>
        <div class="teams_text teams_header">September 26-27, 2023</div>
        <div class="teams_text">Houston, Texas</div>
      </a>

      <div class="howto_item-header teams_text teams_header">
        <a href="https://doi.org/10.6084/m9.figshare.24201960.v1" target="_blank"
          >Virtual Poster Link</a
        >
      </div>
      <div class="howto_item-header teams_text">
        <a href="https://metamaterials.northwestern.edu/" target="_blank">
          Metamaterial Visualization Tool</a
        >
        &ndash; coming soon to MaterialsMine
      </div>
      <accordion
        :startOpen="true"
        :customTitle="true"
...
// Lifecycle: replace created()
onMounted(() => {
  store.commit('setAppHeaderInfo', { icon: 'co_present', name: 'CSSI PI Meeting 2023' });
});
</script>
