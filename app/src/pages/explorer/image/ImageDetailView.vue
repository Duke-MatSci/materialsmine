<template>
    <div class="image-detail-page">
        ...
        <div class="utility-roverflow" v-else-if="getSingleImages && getSingleImages.images">
            ...
            <div class="utility-space search_box_form u--layout-flex-justify-end" v-if="!$apollo.loading">
...
export default {
  ...
  data () {
    return {
      ...
      getSingleImages: { images: [{ description: '', dimension: { width: '', height: '' }, metaData: { id: '', title: '', doi: '' } }] },
      tabbed_content: {
        ri_active: true,
        kw_active: true,
        md_active: false
