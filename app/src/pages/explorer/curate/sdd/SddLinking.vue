            ...
            <md-steppers class="form__stepper" :md-active-step.sync="active" md-linear>
              <md-step id="first" md-label="Dataset Info">
                ...
                <md-card-header>
                  <md-card-header-text>
                    ...
                    <div class="md-title">{{ (optionalChaining(() => dataset[datasetFields['title']][0]['@value'])) || "Curated Dataset" }}
                    </div>
                    <!-- <div class="md-subhead" v-if="dataset[datasetFields['depiction']]">Cover Image: {{ depiction.name }}</div> -->
                  </md-card-header-text>

                  <md-card-media md-big v-show="dataset[datasetFields['depiction']]" style="height:0px">
                    <span id="depictWrapperMini">
                      <figure>
                        <img id="depictImgMini" v-if="thumbnail" :src="(optionalChaining(() => thumbnail[0]['@value']))" alt="Image preview">
                      </figure>
                    </span>
                  </md-card-media>
                </md-card-header>
                <md-card-content>
                  ...
                  <div v-if="orcidData" class="u_margin-bottom-small">
                    ...
                    <div v-if="orcidData['http://www.w3.org/2006/vcard/ns#email']">
                      {{ (optionalChaining(() => orcidData['http://www.w3.org/2006/vcard/ns#email'][0]['@value'])) || 'N/A' }}</div>
                  </div>
                  <div class="u_margin-bottom-small">
                    <h3>Files: </h3>
                    <ul>
              ...
              <md-step id="second" md-label="URI namespace">
                <div class="md-layout">
                  <div style="margin: 20px">
                    ...
                    <div>
                      <md-radio v-model="defaultNamespace" :value="true" style="margin-left:4rem" class="md-primary">Yes,
                        use
                        default</md-radio>
                      <md-radio v-model="defaultNamespace" :value="false" style="margin-left:4rem" class="md-primary">No,
                        use custom</md-radio>
                    </div>
              ...
              <md-step id="fourth" md-label="SDD File" :md-error="invalid.fourth">
                ...
                <div style="margin: 2rem;">
                    ...
                    <md-checkbox v-model="whichSdd" value="uploaded" class="md-primary" v-if="isSddArray.length">
                      ...
                      <span class="">
                        <select class="" v-model="selectSdd" name="selectSdd" id="selectSdd">
                          <option v-for="index in isSddArray" :key="`sdds_${index}`">{{ distributions[index]['label'] + ' ' }} </option>
                        </select>
                      </span>
                    </md-checkbox>
                  </div>
                  ...
                  <div><md-checkbox v-model="whichSdd" value="none" class="md-primary">The SDD used by my data hasn't been
