    ...
    <div class="section_teams">
      <div class="curate">
            ...
            <div class="md-layout-item md-layout-item_card">
              ...
              >
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Use this step-by-step model for curating data instead of
        ...
        <div class="u_margin-top-med">
          <h2 class="visualize_header-h1 metamine_footer-ref-header">
            ...
            <div class="md-layout-item md-layout-item_card">
              ...
              >
                ...
                >
                  ...
                  >
                  <span class="explorer_page-nav-card_text"
                    >Create new chart</span
                  >
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Create a new visualization of chart and validate input.
                    Upload spreadsheet to prefill form and validate input.
                  </p>
                </div>
              </router-link>
            </div>
        ...
        <div class="u_margin-top-med">
          <h2 class="visualize_header-h1 metamine_footer-ref-header">
            Valid Curation List Entry
          </h2>

          <div class="md-layout u_display-flex md-layout-responsive">
            <div class="md-layout-item md-layout-item_card">
              <router-link
                to="/explorer/curate/validList/all"
                v-slot="{ navigate, href }"
                custom
              >
                <div
                ...
                >
                  ...
                  >
                  <span class="explorer_page-nav-card_text"
                    >View all entries</span
                  >
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    View and search a list of all valid curation items entered
                    so far.
                  </p>
                </div>
              </router-link>
            ...
            <div class="md-layout-item md-layout-item_card">
              ...
              >
                ...
                >
                  ...
                  >
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Input valid items from the available lists in the curation
