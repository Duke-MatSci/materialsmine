      ...
      <div class="curate">
              ...
              <router-link to="/explorer/curate/spreadsheet" v-slot="{ navigate, href }" custom>
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Upload filled template spreadsheet for XML conversion.
                  </p>
                </div>
              </router-link>
            </div>
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/stepper" v-slot="{ navigate, href }" custom>
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Use this step-by-step model for curating data instead of using a spreadsheet
                    template.
                  </p>
                </div>
              </router-link>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/sdd" v-slot="{ navigate, href }" custom>
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Submit tidy data files to use with semantic data dictionary (SDD).
                  </p>
                </div>
              </router-link>
            </div>
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/xml" v-slot="{ navigate, href }" custom>
                <div
                  class="teams_container explorer_page-nav-card md-layout-item_card"
                  :href="href"
                  @click="navigate"
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/chart/editor/new" v-slot="{ navigate, href }" custom>
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Create a new visualization of chart and validate input. Upload spreadsheet to
        ...
        <div class="u_margin-top-med">
          ...
          <div class="md-layout u_display-flex md-layout-responsive">
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/validList/all" v-slot="{ navigate, href }" custom>
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    View and search a list of all valid curation items entered so far.
                  </p>
                </div>
              </router-link>
            </div>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/validList" v-slot="{ navigate, href }" custom>
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Input valid items from the available lists in the curation template spreadsheet.
                  </p>
                </div>
              </router-link>
            </div>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link
                to="/explorer/curate/validList/update"
              ...
              >
                ...
                >
                  ...
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Update the existing list of valid entries in the system.
                  </p>
                </div>
              </router-link>
            </div>
