...
const toolRoutes = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chempropsapi" */ '@/pages/nanomine/tools/OtsuBinarization.vue'
      ),
    meta: { requiresAuth: false }
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chempropsapi" */ '@/pages/nanomine/tools/SDFCharacterize.vue'
      ),
    meta: { requiresAuth: false }
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chempropsapi" */ '@/pages/nanomine/tools/SDFReconstruct.vue'
      ),
    meta: { requiresAuth: false }
  }
];
