...
const portalRoutes: Array<RouteRecordRaw> = [
  {
    path: '',
    name: 'PortalHome',
  ...
  },
  {
    ...
    component: () => import('@/pages/portal/user/curation/ApprovedCuration.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: 'user/unapproved-curations',
    name: 'UnapprovedCuratedXML',
    component: () => import('@/pages/portal/user/curation/UnapprovedCuration.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: 'user',
