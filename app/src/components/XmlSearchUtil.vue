<template>
  <div class="gallery">
    <div v-if="searchForm" :class="['utility-roverflow', dense ? '' : 'u--margin-toplg']">
      <div :class="['search_box card-icon-container', dense ? '' : 'u--margin-toplg']">
        <form class="form">
          ...
          <div
            class="form__group search_box_form-item-2 search_box_form-item-2-padded explorer_page-nav u--margin-neg"
            :class="[dense ? 'u--layout-width' : '']"
          >
    ...
    <div class="utility-roverflow">
      ...
      <div
        :class="[
          'gallery-grid',
          'grid',
          dense ? 'grid_col-3 grid_gap-small u_searchimage_input' : 'grid_col-5',
        ]"
      >
        <slot></slot>
      </div>
    ...
    <div
      ...
      :class="['utility-roverflow u_centralize_text', dense ? '' : 'u_margin-top-med']"
    >
