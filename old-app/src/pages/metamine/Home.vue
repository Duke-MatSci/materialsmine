<template>
  <div class="main u_height--max u--layout-flex u--layout-flex-column">
    ...
    <div class="u_margin-top-auto">
      ...
      <div class="card-container">
        ...
        <ul class="u_display-flex ul_adjust">
          <li
            class="card card-float card-adjust"
    ...
    <div class="mid-first u_margin-top-auto">
      <ul class="u_display-flex">
        <li class="inline-display mid-first-li mid-first-container">
          <i class="material-icons card-icon">smart_display</i>
        </li>
        <li class="inline-display mid-first-li mid-first-container">
          <p class="mid-first-p">
            New to MetaMine?
            <span class="mid-first-span">View Our step-by-step tutorials!</span>
          </p>
        </li>
        <li
    ...
    <div class="mid-second">
      <p>
        ...
        <a
          ...
          >Duke's OneLink feature</a
        >. InCommon support is coming soon.
        <a
          href="https://www.incommon.org/federation/incommon-federation-participants/"
          target="_blank"
          class="mid-second-link"
      ...
      <p>
        <span
          >MetaMine is built on both a
          <a
            href="https://github.com/Duke-MatSci/nanomine-schema/tree/master/xml"
            target="_blank"
            class="mid-second-link"
            >schema</a
