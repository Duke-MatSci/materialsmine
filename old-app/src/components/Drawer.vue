<template>
  ...
  >
    <md-list md-expand-single="true" class="utility-transparentbg">
      <md-toolbar
        class="md-transparent u--font-emph-l u_toggle-display-off"
        md-elevation="0"
        ><small>App Navigation</small></md-toolbar
      >
      <div
        class="visualize-pagination-width-mod footer_content-mobile u_margin-none"
      >
      ...
      <md-list-item md-expand>
        ...
        <md-list slot="md-expand">
          ...
          <router-link to="/nm" v-slot="{ navigate, href }" custom>
            <md-list-item :href="href" @click="navigate" class="md-inset"
              >Nanomine</md-list-item
            >
          </router-link>
          <router-link to="/ns" v-slot="{ navigate, href }" custom>
            <md-list-item :href="href" @click="navigate" class="md-inset"
              >Ontology</md-list-item
            >
          </router-link>
        </md-list>
      </md-list-item>
      ...
      <md-toolbar
        class="md-transparent u--font-emph-l u_margin-top-small"
        md-elevation="0"
        ><small>Explore</small></md-toolbar
      >
      <md-divider></md-divider>
      ...
      <md-list-item md-expand>
        ...
        <md-list slot="md-expand">
          ...
          >
            <md-list-item :href="href" @click="navigate" class="md-inset"
              >Module & Simulation Tools</md-list-item
            >
          </router-link>
          <router-link
          ...
          >
            <md-list-item :href="href" @click="navigate" class="md-inset"
              >Sparql Query Interface</md-list-item
            >
          </router-link>
        </md-list>
      </md-list-item>
      ...
      <md-toolbar
        ...
        md-elevation="0"
        v-if="isAuth"
        ><small>User Dashboard</small></md-toolbar
      >
      ...
      <md-list-item md-expand v-if="isAuth">
        ...
        <md-list slot="md-expand">
          ...
          >
            <md-list-item :href="href" @click="navigate" class="md-inset"
              >Upload a Spreadsheet</md-list-item
            >
          </router-link>
          <router-link
          ...
          >
            <md-list-item :href="href" @click="navigate" class="md-inset"
              >Add Xlsx List Entry</md-list-item
            >
          </router-link>
        </md-list>
      </md-list-item>
